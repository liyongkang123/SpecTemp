...
from utils.beir_custom_metrics import hole, mrr, recall_cap, top_k_accuracy
...
class EvaluateRetrieval:
    ...
    def encode_and_retrieve(
        ...
        **kwargs,
        ...
        # Release memory to free up space for subsequent retrieval operations
